...
const Navbar = () => {
  ...
  return (
    <Flex as="nav" px="40px" py="20px" alignItems="center" gap="10px">
        <Heading as="h1">
          <Link href='/diagon-ally-front/account/home' _hover={{textDecoration:"none"}}>DiagonAlly</Link>
        </Heading>
        <Spacer/>
        {user && (
        <>
        ...
        {!user && (
          <>
          <Link p="10px" href='/diagon-ally-front'>Login</Link>
          <Link p="10px" href='/diagon-ally-front/signup'>Sign Up</Link>
          </>
        )}
    </Flex>
  )
